...
export type ModalProps = {
  onCancelClick: (e: React.MouseEvent<HTMLButtonElement, MouseEvent>, modalType: ModalType) => void,
  onConfirmClick: (e: React.MouseEvent<HTMLButtonElement, MouseEvent>, modalType: ModalType) => void,
  title: string,
  body: any,
  confirmTitle: string,
  cancelTitle: string,
      ...
      <div className="p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div className="bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
            ...
            <button onClick={(e) => props.onCancelClick(e, props.modalType)} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="defaultModal">
